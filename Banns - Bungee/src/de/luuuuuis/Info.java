...
public class Info {
	...
	public static void readMessages() {
		...
		try {
			Object obj = new JSONParser()
					.parse(new FileReader(Banns.FilePath + "/" + Info.ServerInfo.get("Language-File") + ".json"));
	...
	public static String getMutedChat() throws IOException {
		String back = Messages.get("MutedChat").replaceAll("%prefix%", Banns.prefix)
				.replaceAll("%reason%", ChatEvent.reason).replaceAll("§", "&");
		return ChatColor.translateAlternateColorCodes('&', back);
	}

	public static String getMutedJoin() throws IOException {
		String back = Messages.get("MutedJoin").replaceAll("%prefix%", Banns.prefix)
				.replaceAll("%reason%", PostJoinEvent.MReason).replaceAll("%remTime%", PostJoinEvent.MTime)
				.replaceAll("§", "&");
		return ChatColor.translateAlternateColorCodes('&', back);
	}

	public static String getBannedJoin() throws IOException {
		String back = Messages.get("BannedJoin").replaceAll("%servername%", (String) ServerInfo.get("Servername"))
				.replaceAll("%timeperm%", JoinEvent.TimeAngabe).replaceAll("%reason%", JoinEvent.grund)
				.replaceAll("%remtime%", JoinEvent.lastSecs).replaceAll("§", "&");
		return ChatColor.translateAlternateColorCodes('&', back);
	}

	public static String getPermaBan() throws IOException {
		String back = Messages.get("PermaBan").replaceAll("%servername%", (String) ServerInfo.get("Servername"))
				.replaceAll("%timeperm%", JoinEvent.TimeAngabe).replaceAll("%reason%", JoinEvent.grund)
				.replaceAll("§", "&");
		return ChatColor.translateAlternateColorCodes('&', back);
	}
	...
	public static String getMuteReason() throws IOException {
		String back = Messages.get("MuteReason").replaceAll("%prefix%", Banns.prefix)
				.replaceAll("%reason%", PluginMessageListener.tReason).replaceAll("§", "&");
		return ChatColor.translateAlternateColorCodes('&', back);
	}

	public static String getBanReason() throws IOException {
		String back = Messages.get("BanReason").replaceAll("%servername%", (String) ServerInfo.get("Servername"))
